...
if not options.inputFiles:
    options.inputFiles = ['/store/data/Run2018B/ParkingBPH4/MINIAOD/05May2019-v2/230000/6B5A24B1-0E6E-504B-8331-BD899EB60110.root']if not options.isMC else ['/store/mc/RunIIAutumn18MiniAOD/BuToKJpsi_Toee_Mufilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen/MINIAODSIM/PUPoissonAve20_BParking_102X_upgrade2018_realistic_v15_ext1-v2/100000/041EF22D-69F5-914D-AD60-F2D1187B0842.root']
...
process.nanoAOD_Kee_step   = cms.Path(process.egammaPostRecoSeq+process.nanoSequence + process.nanoBKeeSequence )
#process.nanoAOD_ElePair_step   = cms.Path(process.nanoSequence + process.ElectronPairSequence  )
